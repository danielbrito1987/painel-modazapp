...
import { CarteiraClientesPieComponent } from './carteira-clientes/carteira-clientes-pie.component';
...
import { VendaSemanalBarComponent } from './venda-semanal/venda-semanal-bar.component';

const components = [
  CarteiraClientesPieComponent,
  VendaSemanalBarComponent
//   ChartjsBarComponent,
...
@NgModule({
  imports: [ThemeModule, RelatoriosRoutingModule, NgxEchartsModule, NgxChartsModule, ChartModule],
